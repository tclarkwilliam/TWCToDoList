...
//  [MagicalRecord setupCoreDataStackWithStoreNamed:@"TWCToDoList.sqlite"];
...
//  }
//  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TWCToDoList" withExtension:@"momd"];
...
//  }
//  
//  NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TWCToDoList.sqlite"];
//  
//  NSError *error = nil;
